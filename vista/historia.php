...
<body>
    ...
    <!-- /Header -->
    <br><br><br><br><div class="timeline">
  
  <h2 class="timeline__item timeline__item--year">2021</h2>
 
  
  <div class="timeline__item">
    <h3 class="timeline__title">Cumpleaños Cenigraf</h3>
    <img src="../logo/54AÑOScenigraf(3).JPG"  class="rounded mx-auto d-block" alt="" id="img1">
  </div>
