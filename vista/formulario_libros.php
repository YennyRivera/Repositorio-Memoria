...
<!--Form-->
<br><div id="feedback-form">
  <h2 class="header">Subir Libros (PDF)</h2>
  <div>
    <form action="../Controlador/subirlibro.php" method="POST" enctype="multipart/form-data">
      <input type="text" name="titulo" placeholder="Titulo del libro" required></input>
      <input type="text" name="año" placeholder="Año del libro" required></input>
      <input type="text" name="formato" placeholder="Formato del libro" required></input>
      <input type="text" name="historia" placeholder="¿Libro historico? SI/NO" required></input>
      <input type="text" name="autor" placeholder="Autor del libro" required></input>
